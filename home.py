...
from_ex_to_home = ctk.CTkButton(sidebar1, text="Home",text_color="#AD4933", font=("Century Gothic", 20), command=lambda: show_frame(home_page), height=40, width=300, fg_color="white", hover_color="gray")
